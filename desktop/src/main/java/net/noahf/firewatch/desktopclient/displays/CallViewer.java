...
public class CallViewer extends GUIPage {
    ...
    private void populateCallData(GridPane viewer) {
        ...
        callDataForm.add(incidentTypeLabel, 0, 0);
        callDataForm.add(incidentType, 1, 0);

        Label priorityLabel = this.formText("Priority");
        ChoiceBox<String> priority = this.choices(176.0, 26.0, new Insets(0.0, 0.0, 0.0, 0.0));
        priority.getItems().addAll(IncidentPriority.asFormattedStrings());
        priority.setValue(this.tryGet(() -> this.incident.incidentPriority().toString()));
        callDataForm.add(priorityLabel, 0, 1);
        callDataForm.add(priority, 1, 1);
        ...
        callDataForm.add(callerTypeLabel, 0, 2);
        callDataForm.add(callerType, 1, 2);
        ...
        callDataForm.add(dispatchTimeLabel, 0, 3);
        callDataForm.add(dispatchTime, 1, 3);
